...
const LeaveApplication = (props) => {
  ...
  const [employee_id, setemployee_id] = useState(props.e_id);
...
else if(validator.isDate(start_date))
{
  ...
  return (
    <div>
      ...
      <i class="bi bi-calendar4-week" style={{fontSize:45,color:"dark"}}></i>
          ...
          <div className="container card ">
            <form className="register-form" >
              ...
              <div className="mb-1 pt-2">
                ...
                {props.id.first_name + " " + props.id.last_name}
              ...
              <div>
                <label htmlFor="Dept" className="form-label  " style={{justifyContent:"center", display:""}}><b>
                  Reason : </b>
                </label>
                <textarea
